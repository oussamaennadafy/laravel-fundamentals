...
@section('content')
    <main class="min-h-[calc(100vh-188px)] w-full flex items-center justify-center">
        <div
            class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10">
            <a href="#">
